                ...
                <div class="xx"><h3 class="clearfix"><strong class="fl">商品 信息</strong>
                    ...
                    <fieldset>
                        ...
                        <form action="addProServlet?" method="post">
                            <div> 商品名称:<input style="border:0.5px solid #bcb7b7" type="text" name="prodouctname"><br></div>
                            <div> 价格:<input style="border:0.5px solid #bcb7b7" type="text" name="prodouctprice"><br></div>
                            <div> 库存:<input style="border:0.5px solid #bcb7b7" type="text" name="prodouctstock"><br></div>
                            <div><input style="width: 80px; height: 21px;border:0.5px solid black" type="submit" value="添加"></div>
                        </form>
                        </center>
                    </fieldset>
                </div>
