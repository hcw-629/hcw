...
<div class="address mt">
    <div class="wrapper clearfix"><a href="index_2.jsp" class="fl">首页</a><span>/</span><a href="mygrxx.jsp" class="on">个人信息</a>
    </div>
</div><!------------------------------Bott------------------------------>
<div class="Bott">
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">${user.name}</span><span class="fr"><a
                        href="loginout">[退出登录]</a></span><span class="fl">钱包余额：${user.balance}</span></p></h3>
            <div><h4> 个人中心</h4>
                <ul>
        ...
        <div class="you fl"><h2>个人信息</h2>
            <div class="gxin">
                ...
                <div class="xx"><h3 class="clearfix"><strong class="fl">基础资料</strong><a href="#" class="fr" id="edit1">修改个人资料></a>
                </h3>
                    <div>姓名：${user.name}</div>
                    <div>密码：<input type="password" name="password" value="${user.password}"/></div>
                    <div>邮箱：${user.email}</div>
                    <div>电话：${user.mobile}</div>
                    <div>收货地址：${user.address}</div>
...
<div class="bj">
    ...
    <h3>修改个人资料</h3>
    <form action="updategrxxServlet" method="post">
        ...
        <p><label>邮箱：</label><input type="text" name="email" value="${user.email}"/></p>
        <p><label>电话：</label><input type="text" name="mobile" value="${user.mobile}"/></p>
        <p><label>收货地址：</label><input type="text" name="address" value="${user.address}"/></p>
