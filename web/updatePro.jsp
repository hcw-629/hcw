...
<div class="address mt">
    <div class="wrapper clearfix"><a href="manager.jsp" class="fl">首页</a><span>/</span><a href="manager.jsp" class="on">个人信息</a>
    </div>
</div><!------------------------------Bott------------------------------>
<div class="Bott">
    <div class="wrapper clearfix">
        <div class="zuo fl">
            ...
            <div><h4> 个人中心</h4>
                <ul>
                    <li><a href="manager.jsp">个人信息</a></li>
                    <li><a href="Managerpro">商品管理</a></li>
                    <li><a href="Manageruser">用户管理</a></li>
                </ul>
            </div>
        </div>
        <div class="you fl"><h2>商品 信息</h2>
            <div class="gxin">
                <div class="tx"><a href="#"><img src="img/tx.png"/>
                </a></div>
                <div class="xx"><h3 class="clearfix"><strong class="fl">商品 信息</strong>
                    ...
                    <form action="updateProServlet" method="post">
                        <div>商品名称:<input style="border:0.5px solid #bcb7b7" type="text" name="prodouctname" size="50" value="${s.prodouctname }"></div>
                        <div>价格：<input style="border:0.5px solid #bcb7b7" type="text" name="prodouctprice" size="30" value="${s.prodouctprice }"></div>
                            <div> 库存：<input style="border:0.5px solid #bcb7b7" type="text" name="prodouctstock" size="30" value="${s.prodouctstock }"></div>
                        <div><input style="width: 80px; height: 21px;border:0.5px solid black" type="submit" value="修改"></div>
                        </c:forEach>
                    </form>
                        </center>
                    </fieldset>
