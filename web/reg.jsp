...
<body><!-------------------reg-------------------------->
<div class="reg">
    <form action="register" method="post" onsubmit="return CheckFrom(this)"><h1>社区果蔬商店</h1>
        <h1 style="padding:0px;magin:0px;font-size:30px;background:#3344AA;text-align:center;line-height:45px;color:#FFFFFF">用户注册</h1>
        <p><input type="text" name="userName" value="" onfocus="FocusItem(this)" onblur="BlueItem(this)" placeholder="请输入用户名称" required><span></span></p>
        <p><input type="text" name="name" value="" onfocus="FocusItem(this)" onblur="BlueItem(this)" placeholder="请输入真实姓名" required><span></span></p>
