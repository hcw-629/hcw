...
//                更新购物车
                ...
                if (Integer.parseInt(count)<=pro.getProdouctstock()) {
                    Cart cart = new Cart(0, pro.getProdouctfilename(), pro.getProdouctname(), pro.getProdouctprice(), Integer.parseInt(count), pro.getProdouctstock(), pro.getProdouctid(), u_id, 1);
                    //插入购物车
                    cartDao.insert(cart);
                    //更新商品库存
