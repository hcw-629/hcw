...
<div class="address mt">
    <div class="wrapper clearfix"><a href="#" class="fl">首页</a><span>/</span><a
            href="mygrxx.jsp">个人中心</a><span>/</span><a href="myorderq.jsp" class="on">我的订单</a></div>
</div><!------------------------------Bott------------------------------>
<div class="Bott">
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">${user.name}</span><span class="fr"><a
                        href="loginout">[退出登录]</a></span>
                    <span class="fl">钱包余额：${user.balance}</span></p></h3>
            <div><h4> 个人中心</h4>
                <ul>
        ...
        <div class="you fl"><h2>商品管理</h2>
            <div class="gxin">
                <div align="left" class="xx">
                    <h3 class="clearfix"><strong class="fl">我的订单</strong>
                    ...
                    <center>
                        ...
                        <a href='<c:if test="${currentPage>1 }">myorderServlet?currentPage=${currentPage-1 }</c:if>'>前一页</a>&nbsp;&nbsp;&nbsp;
                        <c:forEach begin="1" end="${allPage }"  varStatus="st">
                            <a style='<c:if test="${st.count==currentPage}">color:red;</c:if>text-decoration: none' href="myorderServlet?currentPage=${st.count }">
                                第${st.count }页&nbsp;&nbsp;&nbsp;&nbsp;
                            </a>
                        </c:forEach>
                        <a href='<c:if test="${currentPage<allPage }">myorderServlet?currentPage=${currentPage+1 }</c:if>'>下一页</a>
